...
const WHATSAPP_NUMBER = "526181473443"; // 👈 REEMPLAZA CON TU NÚMERO DE WHATSAPP REAL
...
const CartPage = () => {
  ...
  const handleQuantityChange = (productId, event) => {
    ...
    if (isNaN(newQuantity) || newQuantity < 0.5) {
      newQuantity = 0.5; // Mínimo de 0.5 Kg
    }
  ...
  const generateWhatsAppLink = () => {
    ...
    cartItems.forEach((item, index) => {
      ...
      message += `${index + 1}. ${item.name} | ${item.quantity.toFixed(
        1
      )} Kg | Subtotal: $${subtotal}\n`;
    });
            ...
            >
              ...
              <div className="flex flex-col items-end justify-center space-y-2">
                <div className="flex items-center">
                  ...
                  <span className="text-sm ml-2 text-gray-600">Kg</span>
                </div>
